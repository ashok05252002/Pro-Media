...
const YTInsights = () => {
  ...
  return (
    <div className="p-4">
      ...
      <div className="mb-4 bg-gray-100 p-2">{progress}</div>
      ...
      <h2 className="text-xl font-bold mt-6">📅 Daily Trends</h2>
      ...
      <h2 className="text-xl font-bold mt-6">📹 Per-Video Analytics</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {videoData.map((v, i) => (
          <div key={i} className="border p-4">
